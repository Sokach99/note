...
export const sidebar: DefaultTheme.Config['sidebar'] = {
  // 文章分类
  '/archives/service/': getItemsByDate('archives/service'),
  '/archives/problem/': getItemsByDate('archives/problem'),
  '/archives/tools/': getItemsByDate('archives/tools'),

  // 学习文章
  '/articles/java/': getItems('articles/java'),
}
