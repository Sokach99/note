    ...
    <div class="meta-item tag">
      ...
      <span class="meta-content">
        <span v-for="(tag, index) in tags" :key="index">
          <a href="javascript:void(0);" target="_self" :title="tag" @click="goToLink('/archives', 'tag', tag)">{{ tag }}</a>
