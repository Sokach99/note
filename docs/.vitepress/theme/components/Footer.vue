...
<template>
  <footer class="VPFooter">
    <div class="container">
      ...
      <p v-if="theme.footerConfig.copyright" class="copyright" v-html="theme.footerConfig.copyright" />
    </div>
  </footer>
</template>
